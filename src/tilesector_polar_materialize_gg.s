...
; DE = compact shade-0 edge word from edge_lut$.
; Add normal shade offset, or replace the tile with a shade-1 wall-side
; EDGE+vertical-border variant. A border never paints into ceiling/floor.
edge_finish_word$:
        ld      a, (#_g_polar_mat_border)
        and     #3
        jr      z, edge_finish_plain$
        cp      #3
        jr      z, edge_finish_plain$   ; both-border thin faces handled later
        ld      c, a
        ld      a, (#_g_polar_mat_shade)
        cp      #1
        jr      nz, edge_finish_plain$
        bit     1, d                    ; FLIPX swaps physical L/R
        jr      z, edge_border_side_ready$
        ld      a, c
        xor     #3
        ld      c, a
edge_border_side_ready$:
        ld      a, d
        and     #0x0e
        ld      (#r_edge_attrs$), a
        ld      a, e
        ...
        ld      a, c
        cp      #2
        jr      nz, edge_border_index_ready$
        ld      a, l
        add     a, #80
        ld      l, a
edge_border_index_ready$:
        add     hl, hl
        ld      de, #edge_border_lut$
        add     hl, de
        ld      e, (hl)
        inc     hl
        ld      d, (hl)
...
edge_row_open$:
        ...
        ld      a, (#r_edge_left$)
        sub     e
        ; Exact edge_entry saturation domain is [-8,+15].
        cp      #0x80
        jr      c, local_positive$
        cp      #0xF8
        jr      nc, local_ready$
...
edge_lut$:
        ; Compact EDGE LUT: 30 groups x 24 words. raw local saturates at
        ; -8..+15 with exact edge_entry equivalence.
        ; bottom=0 slope=-7
        .dw 0x0228, 0x0228, 0x0228, 0x0228, 0x0228, 0x0228, 0x0228, 0x0228
        .dw 0x0228, 0x0229, 0x022A, 0x022C, 0x0230, 0x0235, 0x023C, 0x0244
        .dw 0x024C, 0x0254, 0x025C, 0x0264, 0x026B, 0x0271, 0x0275, 0x0276
        ; bottom=0 slope=-6
        .dw 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227
        .dw 0x0228, 0x0229, 0x022A, 0x022F, 0x0234, 0x023B, 0x0243, 0x024B
        .dw 0x0253, 0x025B, 0x0263, 0x026B, 0x0271, 0x0275, 0x0276, 0x0276
        ; bottom=0 slope=-5
        .dw 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227
        .dw 0x0228, 0x022B, 0x022E, 0x0233, 0x023A, 0x0242, 0x024A, 0x0252
        .dw 0x025A, 0x0262, 0x026A, 0x0270, 0x0275, 0x0276, 0x0276, 0x0276
        ; bottom=0 slope=-4
        .dw 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227
        .dw 0x0228, 0x022B, 0x0232, 0x0239, 0x0241, 0x0249, 0x0251, 0x0259
        .dw 0x0261, 0x0269, 0x0270, 0x0275, 0x0276, 0x0276, 0x0276, 0x0276
        ; bottom=0 slope=-3
        .dw 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227
        .dw 0x022D, 0x0231, 0x0238, 0x0240, 0x0248, 0x0250, 0x0258, 0x0260
        .dw 0x0268, 0x026F, 0x0274, 0x0276, 0x0276, 0x0276, 0x0276, 0x0276
        ; bottom=0 slope=-2
        .dw 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227
        .dw 0x022D, 0x0237, 0x023F, 0x0247, 0x024F, 0x0257, 0x025F, 0x0267
        .dw 0x026E, 0x0274, 0x0276, 0x0276, 0x0276, 0x0276, 0x0276, 0x0276
        ; bottom=0 slope=-1
        .dw 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227, 0x0227
        .dw 0x0236, 0x023E, 0x0246, 0x024E, 0x0256, 0x025E, 0x0266, 0x026D
        .dw 0x0273, 0x0276, 0x0276, 0x0276, 0x0276, 0x0276, 0x0276, 0x0276
        ; bottom=0 slope=+0
        .dw 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0027
        .dw 0x003D, 0x0045, 0x004D, 0x0055, 0x005D, 0x0065, 0x006C, 0x0072
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+1
        .dw 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0036
        .dw 0x003E, 0x0046, 0x004E, 0x0056, 0x005E, 0x0066, 0x006D, 0x0073
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+2
        .dw 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x002D, 0x0037
        .dw 0x003F, 0x0047, 0x004F, 0x0057, 0x005F, 0x0067, 0x006E, 0x0074
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+3
        .dw 0x0027, 0x0027, 0x0027, 0x0027, 0x0027, 0x002D, 0x0031, 0x0038
        .dw 0x0040, 0x0048, 0x0050, 0x0058, 0x0060, 0x0068, 0x006F, 0x0074
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+4
        .dw 0x0027, 0x0027, 0x0027, 0x0027, 0x0028, 0x002B, 0x0032, 0x0039
        .dw 0x0041, 0x0049, 0x0051, 0x0059, 0x0061, 0x0069, 0x0070, 0x0075
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+5
        .dw 0x0027, 0x0027, 0x0027, 0x0028, 0x002B, 0x002E, 0x0033, 0x003A
        .dw 0x0042, 0x004A, 0x0052, 0x005A, 0x0062, 0x006A, 0x0070, 0x0075
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+6
        .dw 0x0027, 0x0027, 0x0028, 0x0029, 0x002A, 0x002F, 0x0034, 0x003B
        .dw 0x0043, 0x004B, 0x0053, 0x005B, 0x0063, 0x006B, 0x0071, 0x0075
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=0 slope=+7
        .dw 0x0028, 0x0028, 0x0029, 0x002A, 0x002C, 0x0030, 0x0035, 0x003C
        .dw 0x0044, 0x004C, 0x0054, 0x005C, 0x0064, 0x006B, 0x0071, 0x0075
        .dw 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076, 0x0076
        ; bottom=1 slope=-7
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C75, 0x0C71, 0x0C6B, 0x0C64, 0x0C5C, 0x0C54, 0x0C4C, 0x0C44
        .dw 0x0C3C, 0x0C35, 0x0C30, 0x0C2C, 0x0C2A, 0x0C29, 0x0C28, 0x0C28
        ; bottom=1 slope=-6
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C75, 0x0C71, 0x0C6B, 0x0C63, 0x0C5B, 0x0C53, 0x0C4B, 0x0C43
        .dw 0x0C3B, 0x0C34, 0x0C2F, 0x0C2A, 0x0C29, 0x0C28, 0x0C27, 0x0C27
        ; bottom=1 slope=-5
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C75, 0x0C70, 0x0C6A, 0x0C62, 0x0C5A, 0x0C52, 0x0C4A, 0x0C42
        .dw 0x0C3A, 0x0C33, 0x0C2E, 0x0C2B, 0x0C28, 0x0C27, 0x0C27, 0x0C27
        ; bottom=1 slope=-4
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C75, 0x0C70, 0x0C69, 0x0C61, 0x0C59, 0x0C51, 0x0C49, 0x0C41
        .dw 0x0C39, 0x0C32, 0x0C2B, 0x0C28, 0x0C27, 0x0C27, 0x0C27, 0x0C27
        ; bottom=1 slope=-3
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C74, 0x0C6F, 0x0C68, 0x0C60, 0x0C58, 0x0C50, 0x0C48, 0x0C40
        .dw 0x0C38, 0x0C31, 0x0C2D, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27
        ; bottom=1 slope=-2
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C74, 0x0C6E, 0x0C67, 0x0C5F, 0x0C57, 0x0C4F, 0x0C47, 0x0C3F
        .dw 0x0C37, 0x0C2D, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27
        ; bottom=1 slope=-1
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C73, 0x0C6D, 0x0C66, 0x0C5E, 0x0C56, 0x0C4E, 0x0C46, 0x0C3E
        .dw 0x0C36, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27
        ; bottom=1 slope=+0
        .dw 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76, 0x0C76
        .dw 0x0C72, 0x0C6C, 0x0C65, 0x0C5D, 0x0C55, 0x0C4D, 0x0C45, 0x0C3D
        .dw 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27, 0x0C27
        ; bottom=1 slope=+1
        .dw 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E73
        .dw 0x0E6D, 0x0E66, 0x0E5E, 0x0E56, 0x0E4E, 0x0E46, 0x0E3E, 0x0E36
        .dw 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27
        ; bottom=1 slope=+2
        .dw 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E74, 0x0E6E
        .dw 0x0E67, 0x0E5F, 0x0E57, 0x0E4F, 0x0E47, 0x0E3F, 0x0E37, 0x0E2D
        .dw 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27
        ; bottom=1 slope=+3
        .dw 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E74, 0x0E6F, 0x0E68
        .dw 0x0E60, 0x0E58, 0x0E50, 0x0E48, 0x0E40, 0x0E38, 0x0E31, 0x0E2D
        .dw 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27
        ; bottom=1 slope=+4
        .dw 0x0E76, 0x0E76, 0x0E76, 0x0E76, 0x0E75, 0x0E70, 0x0E69, 0x0E61
        .dw 0x0E59, 0x0E51, 0x0E49, 0x0E41, 0x0E39, 0x0E32, 0x0E2B, 0x0E28
        .dw 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27
        ; bottom=1 slope=+5
        .dw 0x0E76, 0x0E76, 0x0E76, 0x0E75, 0x0E70, 0x0E6A, 0x0E62, 0x0E5A
        .dw 0x0E52, 0x0E4A, 0x0E42, 0x0E3A, 0x0E33, 0x0E2E, 0x0E2B, 0x0E28
        .dw 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27
        ; bottom=1 slope=+6
        .dw 0x0E76, 0x0E76, 0x0E75, 0x0E71, 0x0E6B, 0x0E63, 0x0E5B, 0x0E53
        .dw 0x0E4B, 0x0E43, 0x0E3B, 0x0E34, 0x0E2F, 0x0E2A, 0x0E29, 0x0E28
        .dw 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27, 0x0E27
        ; bottom=1 slope=+7
        .dw 0x0E76, 0x0E75, 0x0E71, 0x0E6B, 0x0E64, 0x0E5C, 0x0E54, 0x0E4C
        .dw 0x0E44, 0x0E3C, 0x0E35, 0x0E30, 0x0E2C, 0x0E2A, 0x0E29, 0x0E28
        .dw 0x0E28, 0x0E28, 0x0E28, 0x0E28, 0x0E28, 0x0E28, 0x0E28, 0x0E28

edge_border_lut$:
        ; Shade-1 EDGE tiles with wall-side vertical border.
        ; First 80 = canonical left; next 80 = canonical right.
        ; left
        .dw 0x0010, 0x0117, 0x0118, 0x0119, 0x011A, 0x011B, 0x011C, 0x011D, 0x011E, 0x011F
        .dw 0x0120, 0x0121, 0x0122, 0x0123, 0x0124, 0x0125, 0x0126, 0x0127, 0x0128, 0x0129
        .dw 0x012A, 0x012B, 0x0014, 0x012C, 0x012D, 0x012E, 0x012F, 0x0130, 0x0131, 0x0132
        .dw 0x0133, 0x0134, 0x0135, 0x0136, 0x0137, 0x0138, 0x0139, 0x013A, 0x013B, 0x013C
        .dw 0x013D, 0x013E, 0x013F, 0x0140, 0x0141, 0x0142, 0x0143, 0x0144, 0x0145, 0x0146
        .dw 0x0147, 0x0148, 0x0149, 0x014A, 0x014B, 0x014C, 0x014D, 0x014E, 0x014F, 0x0150
        .dw 0x0151, 0x0152, 0x0153, 0x0154, 0x0155, 0x0156, 0x0157, 0x0158, 0x0159, 0x015A
        .dw 0x015B, 0x015C, 0x015D, 0x015E, 0x015F, 0x0072, 0x0073, 0x0074, 0x0075, 0x0000
        ; right
        .dw 0x0011, 0x0011, 0x0160, 0x0161, 0x0162, 0x0163, 0x0164, 0x0165, 0x0166, 0x0167
        .dw 0x0168, 0x0169, 0x016A, 0x016B, 0x016C, 0x016D, 0x016E, 0x016F, 0x0170, 0x0171
        .dw 0x0172, 0x0173, 0x0015, 0x0174, 0x0175, 0x0176, 0x0177, 0x0178, 0x0179, 0x0094
        .dw 0x017A, 0x017B, 0x017C, 0x017D, 0x017E, 0x017F, 0x009B, 0x009C, 0x0180, 0x0181
        .dw 0x0182, 0x0183, 0x0184, 0x00A2, 0x00A3, 0x00A4, 0x0185, 0x0186, 0x0187, 0x0188
        .dw 0x00A9, 0x00AA, 0x00AB, 0x00AC, 0x0189, 0x018A, 0x018B, 0x00B0, 0x00B1, 0x00B2
        .dw 0x00B3, 0x00B4, 0x018C, 0x018D, 0x00B7, 0x00B8, 0x00B9, 0x00BA, 0x00BB, 0x018E
        .dw 0x00BD, 0x00BE, 0x00BF, 0x00C0, 0x00C1, 0x0072, 0x0073, 0x0074, 0x0075, 0x0000
