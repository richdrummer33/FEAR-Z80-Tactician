...
; Retained swept-boundary path (rung 26).
        ...
        .globl  _g_tspf_boundary_any_dirty
...
seam_prev_col_test$:
        ; Macro-off / no-boundary common case: avoid paying the indexed lookup
        ; on every retained-column probe.  The boundary pre-pass raises this
        ; byte only when at least one previous/current exact-X column needs
        ; forced coarse materialization.
        ld      a, (#_g_tspf_boundary_any_dirty)
        or      a
        ret     z
...
seam_vid$:
        .ds     32
_g_tspf_seam_vertex_half::
seam_vertex_half$:
        .ds     32
seam_prev_cols$:
        .ds     3
_g_tspf_seam_cur_cols::
seam_cur_cols$:
        .ds     3
r_seam_i$:
        .ds     1
