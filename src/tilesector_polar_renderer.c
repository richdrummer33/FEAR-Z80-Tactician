...
#endif
        /* Silhouette-only experiment: a shared physical corner between two
         * adjacent visible spans is interior, so neither side emits a black
         * vertical border. Outer visible-series bounds remain untouched. */
        l->right_real=0u;
        r->left_real=0u;
    }
}
