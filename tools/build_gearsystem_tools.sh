...
echo "[9/9] Building Polar visual capture tool..."
g++ -std=c++17 -O2 -Wall -Wextra "${INC[@]}" \
  "$PORT/tools/polar_visual_capture.cpp" "${COMMON[@]}" \
  -o "$PORT/build/polar_visual_capture"
...
echo "  $PORT/build/polar_visual_capture"
