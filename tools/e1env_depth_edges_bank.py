...
void {fn}(uint8_t yaw,uint8_t c0,uint8_t c1,int16_t dq4) BANKED {{
    ...
    /* Exact final coarse-edge FULL height. The Q6 step below is intentionally
     * compact/quantized and need not land back on b after N additions, so the
     * materializer uses this byte for the final right endpoint. */
    g_e1env_depth_end_half=(uint8_t)(b>>1);
    {{
