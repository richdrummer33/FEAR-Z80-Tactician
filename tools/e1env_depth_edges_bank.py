...
def main():
    ...
    hdr=[
        ...
        "extern uint8_t g_e1env_depth_end_inv;",
    ]
    ...
    for bank_i in range(bank_count):
        ...
        bridge_defs=("int16_t g_e1env_depth_iq;\n"
                     ...
                     "uint8_t g_e1env_depth_end_inv;") if bank_i==0 else (
                     "extern int16_t g_e1env_depth_iq;\n"
                     "extern int16_t g_e1env_depth_step;\n"
                     "extern uint8_t g_e1env_depth_end_inv;")
...
void {fn}(uint8_t yaw,uint8_t c0,uint8_t c1,int16_t dq4) BANKED {{
    ...
    /* Preserve the exact final coarse-edge inverse depth. The compact Q6
     * step below is intentionally approximate; connected-corner code can
     * interpolate BACK from this exact boundary to the true sub-column vertex. */
    g_e1env_depth_end_inv=b;
    {{
