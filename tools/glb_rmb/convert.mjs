...
if(args.length<2) fail('usage: convert.mjs INPUT.glb OUTPUT.inc [--name doomguy] [--height 19] [--up z] [--visual-tris 1800] [--shadow-tris 350]');
 ...
 */
`;
const body=header+emitMesh(name,'visual',visualGeom,visualQ8)+'\n'+emitMesh(name,'shadow',shadowGeom,shadowQ8);
